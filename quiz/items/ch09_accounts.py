...
ITEMS = [
{
 ...
 "difficulty": 2, "kind": "concept", "tags": ["accounts", "state"],
  ...
  "stem": "What are the fields of a service account A in GP 0.8.0 (eq. 9.3) — and which field an Ethereum developer would expect is missing?",
 "options": [
...
},
{
 ...
 "difficulty": 2, "kind": "concept", "tags": ["accounts", "privileges"],
  ...
  "stem": "The privileges state χ ≡ (χ_M, χ_V, χ_R, χ_A, χ_Z). What power does each component grant?",
 "options": [
...
},
{
 ...
 "difficulty": 1, "kind": "rationale", "tags": ["accounts", "preimages", "rationale"],
  ...
  "stem": "The GP lists three differences between preimage lookups and general storage. What are they — and what plausible-sounding fourth 'difference' is actually false?",
 "options": [
