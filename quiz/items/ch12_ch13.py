...
},
{
 ...
 "difficulty": 3, "kind": "concept", "tags": ["accumulate", "work-report"],
  ...
  "optionsZh": [
   ...
   "R! = 沒有 prerequisites 且 segment-root lookup 為空的 report，立即 accumulate；R^Q = 其餘者，各自配上依賴集合（prerequisites ∪ srlookup 的 key）並先用 ξ_∪ 修剪；R* = R! ⌢ Q(E(ω[..m] ⌢ ω[m..] ⌢ R^Q, P(R!)))，也就是 ready queue 從當前 slot m 往後讀，好讓最新排入的 report 先輪到",
...
},
{
 ...
 "difficulty": 3, "kind": "concept", "tags": ["statistics", "core"],
