...
ITEMS = [
 ...
 "lens": "設計",
  ...
  "optionsZh": [
   ...
   "由出塊者直接寫入：出塊者在自己的 slot 內被信任去套用使用者請求，事後若套用有誤才會被懲罰",
 ...
 "lens": "時機",
  ...
  "difficulty": 2, "kind": "rationale", "tags": ["state root", "header"],
  "alsoCh": ["N3"],
  ...
  "optionsZh": [
   ...
   "建在同一個父區塊上的兩個區塊必定帶有相同的 root，因此分叉可以只比較 slot 而不必碰狀態就解決",
 ...
 "lens": "設計",
  ...
  "difficulty": 1, "kind": "concept", "tags": ["state root"],
 ...
 "lens": "設計",
  ...
  "difficulty": 2, "kind": "rationale", "tags": ["extrinsic", "header"],
